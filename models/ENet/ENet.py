...
class ENet(nn.Module):
    ...
    def __init__(self, nclass=1, backbone='', aux=False, jpu=False, pretrained_base=None, **kwargs):
...
class UpsamplingBottleneck(nn.Module):
    ...
    def __init__(self, in_channels, inter_channels, out_channels, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.upsampling = nn.ConvTranspose2d(out_channels, out_channels, kernel_size=2, stride=2)#nn.MaxUnpool2d(2)
